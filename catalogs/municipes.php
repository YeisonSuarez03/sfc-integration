<?php
function insertMunicipes(){

    global $wpdb;

    $municipiosTableName = "{$wpdb->prefix}sfcwp_municipios";

    if (!verifyDataTable($municipiosTableName)) {

        $insertMunicipalities = "INSERT INTO {$municipiosTableName}
        (departmentCode, munCode, munName)
        VALUES
        (05, 	5001, 	'MEDELLÍN'),
        (05, 	5002, 	'ABEJORRAL'),
        (05, 	5004, 	'ABRIAQUÍ'),
        ...
        (05, 	5543, 	'PEQUE'),
        (05, 	5576, 	'PUEBLORRICO'),
        (05, 	5579, 	'PUERTO BERRÍO'),
        (05, 	5585, 	'PUERTO NARE'),
        (05, 	5591, 	'PUERTO TRIUNFO'),
        (05, 	5604, 	'REMEDIOS'),
        (05, 	5607, 	'RETIRO'),
        (05, 	5615, 	'RIONEGRO'),
        (05, 	5628, 	'SABANALARGA'),
        (05, 	5631, 	'SABANETA'),
        (05, 	5642, 	'SALGAR'),
        (05, 	5647, 	'SAN ANDRÉS DE CUERQUÍA'),
        (05, 	5649, 	'SAN CARLOS'),
        (05, 	5652, 	'SAN FRANCISCO'),
        (05, 	5656, 	'SAN JERÓNIMO'),
        (05, 	5658, 	'SAN JOSÉ DE LA MONTAÑA'),
        (05, 	5659, 	'SAN JUAN DE URABÁ'),
        (05, 	5660, 	'SAN LUIS'),
        (05, 	5664, 	'SAN PEDRO DE LOS MILAGROS'),
        (05, 	5665, 	'SAN PEDRO DE URABÁ'),
        (05, 	5667, 	'SAN RAFAEL'),
        (05, 	5670, 	'SAN ROQUE'),
        (05, 	5674, 	'SAN VICENTE FERRER'),
        (05, 	5679, 	'SANTA BÁRBARA'),
        (05, 	5686, 	'SANTA ROSA DE OSOS'),
        (05, 	5690, 	'SANTO DOMINGO'),
        (05, 	5697, 	'EL SANTUARIO'),
        (05, 	5736, 	'SEGOVIA'),
        (05, 	5756, 	'SONSÓN'),
        (05, 	5761, 	'SOPETRÁN'),
        (05, 	5789, 	'TÁMESIS'),
        ...
        (05, 	5858, 	'VEGACHÍ'),
        (05, 	5861, 	'VENECIA'),
        (05, 	5873, 	'VIGÍA DEL FUERTE'),
        (05, 	5885, 	'YALÍ'),
        (05, 	5887, 	'YARUMAL'),
        (05, 	5890, 	'YOLOMBÓ'),
        (05, 	5893, 	'YONDÓ'),
        (05, 	5895, 	'ZARAGOZA'),
        (08, 	8001, 	'BARRANQUILLA'),
        (08, 	8078, 	'BARANOA'),
        (08, 	8137, 	'CAMPO DE LA CRUZ'),
        (08, 	8141, 	'CANDELARIA'),
        (08, 	8296, 	'GALAPA'),
        (08, 	8372, 	'JUAN DE ACOSTA'),
        (08, 	8421, 	'LURUACO'),
        (08, 	8433, 	'MALAMBO'),
        (08, 	8436, 	'MANATÍ'),
        (08, 	8520, 	'PALMAR DE VARELA'),
        (08, 	8549, 	'PIOJÓ'),
        (08, 	8558, 	'POLONUEVO'),
        (08, 	8560, 	'PONEDERA'),
        (08, 	8573, 	'PUERTO COLOMBIA'),
        (08, 	8606, 	'REPELÓN'),
        (08, 	8634, 	'SABANAGRANDE'),
        (08, 	8638, 	'SABANALARGA'),
        (08, 	8675, 	'SANTA LUCÍA'),
        (08, 	8685, 	'SANTO TOMÁS'),
        (08, 	8758, 	'SOLEDAD'),
        ...
        (99, 	99773, 	'CUMARIBO')
        ";
        $wpdb->query($insertMunicipalities);
    }
